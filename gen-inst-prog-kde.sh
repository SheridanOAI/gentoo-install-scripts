...
echo '01. Установка дополнительных флагов для Conky'
echo 'app-admin/conky imlib curl lua bundled-toluapp rss ABI_X86=(64) LUA_SINGLE_TARGET="lua5-3"' >> /etc/portage/package.use/conky
...
app-arch/unrar app-dicts/aspell-ru app-misc/neofetch sys-apps/nvme-cli"
...
export PACKAGES="media-sound/audacious sys-apps/gnome-disk-utility kde-apps/dolphin media-sound/kid3 \
media-sound/soundconverter media-sound/flacon kde-apps/kcalc games-board/gnome-mahjongg \
app-admin/conky media-sound/pavucontrol-qt kde-apps/gwenview www-client/firefox-bin \
